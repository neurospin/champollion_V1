...
if __name__ == "__main__":
    ...
    embeddings_pipeline("/neurospin/dico/data/deep_folding/current/models/Champollion_V0_trained_on_UKB40",
                        dataset_localization="neurospin",
                        datasets_root="with_reskel_distbottom/2mm/imagen",
                        datasets=["toto"],
                        labels=['IHI_left'],
                        classifier_name='logistic',
                        short_name='imagen', overwrite=True, embeddings=True,
                        embeddings_only=True, use_best_model=False,
                        subsets=['full'], epochs=range(80, 81, 1), split='random', cv=5,
                        splits_basedir='',
                        verbose=False)
    
    # embeddings_pipeline("/neurospin/dico/data/deep_folding/current/models/Champollion_V0/ORBITAL_left",
    #                 dataset_localization="neurospin",
    #                 datasets_root="with_reskel_distbottom/2mm/hcp",
    #                 datasets=["ORBITAL_left"],
    #                 labels=['Left_OFC'],
    #                 classifier_name='logistic',
