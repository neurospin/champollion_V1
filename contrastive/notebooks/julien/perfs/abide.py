...
# best local regions in cross val (256 dims)
"""
regions_to_treat = ['FCLp-subsc-FCLa-INSULA_right',
 'SC-SPeC_right',
 'FColl-SRh_right',
 'STi-SOTlat_left',
 'OCCIPITAL_right',
...
# best local regions in cross val (32 dims)
"""
regions_to_treat = ['FCLp-subsc-FCLa-INSULA_right',
 'FColl-SRh_right',
 'SOr-SOlf_left',
...
#select only the regions to treat
dfs_dirs = [elem for elem in dfs_dirs if any((i in elem.split('/')) for i in regions_to_treat)]
print(f'Number of regions used : {len(dfs_dirs)}')
...
print(f'Dimension after PCA : {reduced_matrix.shape}')
