...
class Config:
    ...
    def __init__(self):
        ...
        self.in_shape = (1, 52, 48, 48) #input size #43, 41, 44 without padding R CS
        #self.in_shape = (1, 52, 48, 48) #input size #43, 43, 44 without padding L CS
        ...
        self.data_dir = f"/neurospin/dico/data/deep_folding/current/datasets/UkBioBank/crops/2mm/babies/{sulcus}/mask/{side}skeleton.pkl" #need to change R to L
        ...
        self.subject_dir = f"/neurospin/dico/data/deep_folding/current/datasets/UkBioBank/crops/2mm/babies/{sulcus}/mask/{side}skeleton_subject.csv"
        #self.subject_dir = "/neurospin/dico/data/deep_folding/current/datasets/UkBioBank/crops/2mm/CINGULATE.baby/mask/Lskeleton_subject_int.csv"
